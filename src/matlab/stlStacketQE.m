...
inputSize = 17;
numClasses = 1;
hiddenSizeL1 = 10;    % Layer 1 Hidden Size
hiddenSizeL2 = 8;    % Layer 2 Hidden Size
...
uFile1 = '/data/mrios/workspace/data/autodesk/sent.training.autodesk.en-pt.pe.quest';
uFile2 = '/data/mrios/workspace/data/autodesk/sent.training.autodesk.pt-es.quest';
trainingFile = '/data/mrios/workspace/data/autodesk/sent.training.autodesk.en-es.pe.quest';
trainingLabel = '/data/mrios/workspace/data/autodesk/autodesk.training.en-es.hter';
testFile = '/data/mrios/workspace/data/autodesk/sent.test.autodesk.pt-es.quest';
testLabel = '/data/mrios/workspace/data/autodesk/autodesk.test.pt-es.hter';
uName='';
...
RHO = corr(testLabels, pred, 'Pearson')
