...
trainLabels = trainLabels.';
dlmwrite(strcat(trainingFile, '.2.stl'), trainFeatures, 'delimiter', '\t');
dlmwrite(strcat(testFile, '.pred.2.stl'), pred.', 'delimiter', '\t');
dlmwrite(strcat(testFile, '.2.stl'), testFeatures, 'delimiter', '\t');
%save theta
